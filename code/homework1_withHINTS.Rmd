...
6\. Download the data dictionary from eLC, "Carvana_Data_Dictionary.txt" Open the file and determine the deliminator. Use the `read_delim()` function to import the file into R and assign it the name "key".  
